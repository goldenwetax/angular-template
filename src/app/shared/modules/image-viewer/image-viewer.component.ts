...
export class ImageViewerComponent implements OnInit {
  ...
  @Input() preivewVisible:boolean = false;
  @Output() previewChange:EventEmitter<boolean> = new EventEmitter();

  public style = { transform: '', msTransform: '', oTransform: '', webkitTransform: '',transition:'' };
  ...
  private updateStyle() {
      ...
      this.style.transition = `.1s transform linear`;
  }
